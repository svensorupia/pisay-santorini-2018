...
class Grid:
    ...
    def __str__(self):
        '''
        Returns a seven string representation (with axis labels) of the grid of tiles. Tiles are indexed according to Cartesian Coordinates.
        '''
        buildLine = ""
...
class Player:
    ...
    '''
    Moves a builder. Returns a number indicating which builder was moved.
    '''
    def move(self):
        validInput = False
